...
[![Tests](https://img.shields.io/badge/tests-236%20unit-informational)](https://github.com/acebmxer/xcp_pulse/actions/workflows/ci.yml)
...
> [!NOTE]
> XCP Pulse is being built in stages. **v0.5.3 masks addresses, tokens and
